...
5. [Connecting to Airtable](https://supabase.com/docs/guides/database/extensions/wrappers/airtable)
...
![airtable_credentials](https://raw.githubusercontent.com/supabase/wrappers/docs_v0.5.6/docs/assets/airtable_credentials.png)
...
[Edit this page on GitHub](https://github.com/supabase/wrappers/blob/docs_v0.5.6/docs/catalog/airtable.md)
