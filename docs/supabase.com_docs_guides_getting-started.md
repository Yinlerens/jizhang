...
Expo React Native\\
\\
Learn how to build a user management app with Expo React Native and Supabase Database, Auth, and Storage functionality.](https://supabase.com/docs/guides/getting-started/tutorials/with-expo-react-native) [![Expo React Native Social Auth](https://supabase.com/docs/img/icons/expo-icon-light.svg)\\
\\
Expo React Native Social Auth\\
\\
Learn how to implement social authentication in an app with Expo React Native and Supabase Database and Auth functionality.](https://supabase.com/docs/guides/getting-started/tutorials/with-expo-react-native-social-auth) [![Android Kotlin](https://supabase.com/docs/img/icons/kotlin-icon.svg)\\
\\
Android Kotlin\\
\\
