---
url: "https://supabase.com/docs/reference/javascript/auth-admin-oauth-approveauthorization"
...
Auth
  ...
  - [Initialize client session](https://supabase.com/docs/reference/javascript/auth-initialize)
  - Auth MFA
  ...
  - OAuth Server
    ...
    [OAuth Server](https://supabase.com/docs/reference/javascript/auth-admin-oauth-server) - [Get authorization details](https://supabase.com/docs/reference/javascript/auth-admin-oauth-getauthorizationdetails)
- [Approve authorization](https://supabase.com/docs/reference/javascript/auth-admin-oauth-approveauthorization)
- [Deny authorization](https://supabase.com/docs/reference/javascript/auth-admin-oauth-denyauthorization)
- [List grants](https://supabase.com/docs/reference/javascript/auth-admin-oauth-listgrants)
- [Revoke grant](https://supabase.com/docs/reference/javascript/auth-admin-oauth-revokegrant)
...
### Install as package [\#](https://supabase.com/docs/reference/javascript/auth-admin-oauth-approveauthorization\#install-as-package)
...
### Install via CDN [\#](https://supabase.com/docs/reference/javascript/auth-admin-oauth-approveauthorization\#install-via-cdn)
...
### Use at runtime in Deno [\#](https://supabase.com/docs/reference/javascript/auth-admin-oauth-approveauthorization\#use-at-runtime-in-deno)
...
## Generating TypeScript Types [\#](https://supabase.com/docs/reference/javascript/auth-admin-oauth-approveauthorization\#generating-typescript-types)
...
## Using TypeScript type definitions [\#](https://supabase.com/docs/reference/javascript/auth-admin-oauth-approveauthorization\#using-typescript-type-definitions)
...
## Helper types for Tables and Joins [\#](https://supabase.com/docs/reference/javascript/auth-admin-oauth-approveauthorization\#helper-types-for-tables-and-joins)
...
### Response types for complex queries [\#](https://supabase.com/docs/reference/javascript/auth-admin-oauth-approveauthorization\#response-types-for-complex-queries)
...
\
This method returns authorization details including client info, scopes, and user information. If the response includes a redirect\_uri, it means consent was already given - the caller should handle the redirect manually if needed.\
\
### Parameters\
\
...
\
\
Get catalog and create tableList tables in namespaceWorking with namespacesCleanup operations\
\
```\
1\
