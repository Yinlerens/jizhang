---
url: "https://supabase.com/docs/reference/api/v1-reset-a-branch"
...
## Authentication [\#](https://supabase.com/docs/reference/api/v1-read-only-query\#authentication)
...
## Rate limits [\#](https://supabase.com/docs/reference/api/v1-read-only-query\#rate-limits)
...
### Standard rate limit [\#](https://supabase.com/docs/reference/api/v1-read-only-query\#standard-rate-limit)
...
### Rate limit scope [\#](https://supabase.com/docs/reference/api/v1-read-only-query\#rate-limit-scope)
...
### Rate limit response headers [\#](https://supabase.com/docs/reference/api/v1-read-only-query\#rate-limit-response-headers)
...
### How rate limits are tracked [\#](https://supabase.com/docs/reference/api/v1-read-only-query\#how-rate-limits-are-tracked)
...
### Endpoint exceptions [\#](https://supabase.com/docs/reference/api/v1-read-only-query\#endpoint-exceptions)
...
### Best practices [\#](https://supabase.com/docs/reference/api/v1-read-only-query\#best-practices)
