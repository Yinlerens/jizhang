...
- Database backups are not available for download for Free Plan projects.
  - You can set up your own backup systems using tools like [pg\_dump](https://www.postgresql.org/docs/current/app-pgdump) or [wal-g](https://github.com/wal-g/wal-g).
