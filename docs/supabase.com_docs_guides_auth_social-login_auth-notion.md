...
title: "Login with Notion | Supabase Docs"
---
...
[Auth](https://supabase.com/docs/guides/auth/social-login/auth-notion)
...
7. [Notion](https://supabase.com/docs/guides/auth/social-login/auth-notion)
...
[Edit this page on GitHub](https://github.com/supabase/supabase/blob/master/apps/docs/content/guides/auth/social-login/auth-notion.mdx)
