...
title: "Postgres Roles | Supabase Docs"
---
...
### `supabase_etl_admin` [\#](https://supabase.com/docs/guides/database/postgres/roles\#supabaseetladmin)

Used by [Replication powered by Supabase ETL](https://supabase.com/docs/guides/database/replication) to replicate database changes to external destinations. Has read-all access and replication privileges for change data capture, bypasses Row Level Security, and can write to the `etl` schema.
