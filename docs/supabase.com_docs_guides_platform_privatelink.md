...
#### Step 1: Add AWS account [\#](https://supabase.com/docs/guides/platform/privatelink\#step-1-add-aws-account)
...
#### Step 7: Disable public connectivity (optional) [\#](https://supabase.com/docs/guides/platform/privatelink\#step-7-disable-public-connectivity-optional)
...
## Beta limitations [\#](https://supabase.com/docs/guides/platform/privatelink\#beta-limitations)
