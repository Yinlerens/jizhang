...
This guide covers setting up **manual logical replication** using external tools. If you prefer a simpler, managed solution, read [the Replication setup docs](https://supabase.com/docs/guides/database/replication/replication-setup) instead.
