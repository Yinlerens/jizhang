---
url: "https://supabase.com/docs/reference/javascript/v1/contains"
...
## Upgrade the client library [\#](https://supabase.com/docs/reference/javascript/v1/contains\#upgrade-the-client-library)
...
### Auth methods [\#](https://supabase.com/docs/reference/javascript/v1/contains\#auth-methods)
...
#### Sign in with email and password [\#](https://supabase.com/docs/reference/javascript/v1/contains\#sign-in-with-email-and-password)
...
#### Sign in with magic link [\#](https://supabase.com/docs/reference/javascript/v1/contains\#sign-in-with-magic-link)
...
#### Sign in with a third-party provider [\#](https://supabase.com/docs/reference/javascript/v1/contains\#sign-in-with-a-third-party-provider)
...
#### Sign in with phone [\#](https://supabase.com/docs/reference/javascript/v1/contains\#sign-in-with-phone)
...
#### Sign in with phone using OTP [\#](https://supabase.com/docs/reference/javascript/v1/contains\#sign-in-with-phone-using-otp)
...
#### Reset password for email [\#](https://supabase.com/docs/reference/javascript/v1/contains\#reset-password-for-email)
...
#### Get the user's current session [\#](https://supabase.com/docs/reference/javascript/v1/contains\#get-the-users-current-session)
...
#### Get the logged-in user [\#](https://supabase.com/docs/reference/javascript/v1/contains\#get-the-logged-in-user)
...
#### Update user data for a logged-in user [\#](https://supabase.com/docs/reference/javascript/v1/contains\#update-user-data-for-a-logged-in-user)
...
#### Use a custom `access_token` JWT with Supabase [\#](https://supabase.com/docs/reference/javascript/v1/contains\#use-a-custom-accesstoken-jwt-with-supabase)
...
### Cookie methods [\#](https://supabase.com/docs/reference/javascript/v1/contains\#cookie-methods)
...
### Data methods [\#](https://supabase.com/docs/reference/javascript/v1/contains\#data-methods)
...
#### Insert and return data [\#](https://supabase.com/docs/reference/javascript/v1/contains\#insert-and-return-data)
...
#### Update and return data [\#](https://supabase.com/docs/reference/javascript/v1/contains\#update-and-return-data)
...
#### Upsert and return data [\#](https://supabase.com/docs/reference/javascript/v1/contains\#upsert-and-return-data)
...
#### Delete and return data [\#](https://supabase.com/docs/reference/javascript/v1/contains\#delete-and-return-data)
...
### Realtime methods [\#](https://supabase.com/docs/reference/javascript/v1/contains\#realtime-methods)

#### Subscribe [\#](https://supabase.com/docs/reference/javascript/v1/contains\#subscribe)
...
#### Unsubscribe [\#](https://supabase.com/docs/reference/javascript/v1/contains\#unsubscribe)
...
### Applying Filters [\#](https://supabase.com/docs/reference/javascript/v1/contains\#applying-filters)
...
### Chaining [\#](https://supabase.com/docs/reference/javascript/v1/contains\#chaining)
...
### Conditional Chaining [\#](https://supabase.com/docs/reference/javascript/v1/contains\#conditional-chaining)
