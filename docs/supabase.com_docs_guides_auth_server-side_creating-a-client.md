...
[View source](https://github.com/supabase/supabase/blob/d3ca2a5a4b6a2e8984cb9228e664cfed1423f2ac/examples/auth/nextjs/lib/supabase/client.ts)

### Hook up proxy [\#](https://supabase.com/docs/guides/auth/server-side/creating-a-client\#hook-up-proxy)
...
[View source](https://github.com/supabase/supabase/blob/d3ca2a5a4b6a2e8984cb9228e664cfed1423f2ac/examples/auth/nextjs/proxy.ts)
