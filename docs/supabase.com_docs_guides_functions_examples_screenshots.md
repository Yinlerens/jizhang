...
title: "Taking Screenshots with Puppeteer | Supabase Docs"
---
...
3. Examples
5. [Taking Screenshots with Puppeteer](https://supabase.com/docs/guides/functions/examples/screenshots)
...
[Edit this page on GitHub](https://github.com/supabase/supabase/blob/master/apps/docs/content/guides/functions/examples/screenshots.mdx)
