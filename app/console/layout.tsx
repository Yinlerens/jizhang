...
import AdminShell from "@/app/admin/gacha/AdminShell";
import { ConsoleShellLoading } from "@/components/console/ConsoleLoading";

export default function ConsoleLayout({ children }: { children: ReactNode }) {
  return (
    <Suspense fallback={<ConsoleShellLoading />}>
      <AuthenticatedConsoleShell>{children}</AuthenticatedConsoleShell>
    </Suspense>
  );
}

async function AuthenticatedConsoleShell({ children }: { children: ReactNode }) {
